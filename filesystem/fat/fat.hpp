...
namespace fat {
    ...
    file_info *write_file_info_by_sfn(file_t *file_dir , physical_file_location *dir_loc , const char *phys_file_name , const sfn_entry_t &sfn_entry , fat::general_fat_info_t &ginfo);
    ...
    int get_file_list(file_t *dir_file , LinkedList<file_t*> &file_list , general_fat_info_t &ginfo);
};
